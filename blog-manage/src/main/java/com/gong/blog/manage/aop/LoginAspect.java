...
public class LoginAspect {
     ...
     * 后置通知
     */
    @AfterReturning(value = "execution(* com.gong.blog.manage.controller.user.LoginController.login(*))", returning = "result")
     ...
     * 后置异常通知
     */
    @AfterThrowing(value = "execution(* com.gong.blog.manage.controller.user.LoginController.login(*))", throwing = "ex")
